...
* Add SMS autoFill for IOS/Android/Web
...
### Added `_lastEmptyTextController(int index)` Method
...
### Updated `_onBackButtonClick` Behavior
...
### TextField Configuration Changes
...
* Fixed problems related to onError and onSuccess callback handling
...
* Added `onError` and `onSuccess` functions
* Added built-in error/success handling
* Removed `onSubmit` function when user pastes code
